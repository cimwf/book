<template>
    <div class="list-top">
        ...
        <div>
            <ul>
                <router-link :to="'/detail/shop?id='+detail" tag="li" active-class="active">商品</router-link>
                <router-link to="/detail/detail" tag="li" active-class="active">详情</router-link>
                <router-link to="/detail/review" tag="li" active-class="active">评论</router-link>
                <router-link to="/detail/recommend" tag="li" active-class="active">推荐</router-link>
            </ul>
        </div>
        <div>
            ...
            &:nth-child(2)
                ...
                ul 
                    ...
                    .active
                        ...
                        border-bottom 0.01rem solid rgb(255,129,97)
